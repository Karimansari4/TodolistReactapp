      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            <Menu id="menu-appbar" anchorEl={anchorElNav} anchorOrigin={{ vertical: 'bottom', horizontal: 'left', }} keepMounted
              ...
              sx={{ display: { xs: 'block', md: 'none' }, }} >
                ...
                <MenuItem onClick={handleCloseNavMenu}>
                    <Link to={'/addToDo'} style={{ textDecoration: 'none'}}><Typography textAlign="center">Add ToDo</Typography></Link> 
                </MenuItem>
            </Menu>
          </Box>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            <Link to={'/'} style={{ textDecoration: 'none', color: 'white'}}><Typography textAlign="center"><Button onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white', display: 'block' }} > Home </Button></Typography></Link> 
            
            <Link to={'/addToDo'} style={{ textDecoration: 'none', color: 'white'}}><Typography textAlign="center"><Button onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white', display: 'block' }} > Add ToDo </Button></Typography></Link> 
